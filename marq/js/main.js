(function ($) {
    ...
    // Menu.
    $('#menu-artmarq')
        .append('<a href="#menu-artmarq" class="close"></a>')
        .appendTo($body)
        .panel({
            delay: 500,
            hideOnClick: true,
    ...
    $('a[href^="http:"]').not('[href*="' + baseUrl + '"]').addClass('external').attr({
        target: "_blank"
    });
    ...
    function prevNextTabs(e, $t) {
        ...
        if (!$t.hasClass('disabled')) {
            ...
            if ($t.hasClass('btn-prev')) {
                ...
                $wrapper.animate({
                    scrollLeft: (currentScroll - distance)
                }, animSpeed, function () {
                ...
                $wrapper.animate({
                    scrollLeft: (distance + currentScroll)
                }, animSpeed, function () {
